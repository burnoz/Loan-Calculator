...
if args_list[1] is not None and args_list[1] < 0 or args_list[2] is not None and args_list[2] < 0 or args_list[3] is \
        not None and args_list[3] < 0 or args_list[4] is not None and args_list[4] < 0.0:
